...
- AI-assisted building and agentic coding
- Practical AI education
- Product strategy and user research
- Growth, sales, positioning, and distribution
- Behavioral economics, persuasion, and negotiation
- Personal knowledge systems and research workflows
- Close-up card magic, music, and drums
...
`Codex` `ChatGPT` `Claude Code` `Vercel` `Github` `NotebookLM` `Wispr Flow` `Granola` `Membase` `Fabric` `Blip` `WhatsApp` `Excel`
...
I am interested in people and teams working on AI tools, product adoption, education, user research, growth, or strange new workflows that make people faster and more capable.

I do not fit perfectly into one box, and I am not trying to. I am most useful where building, thinking, teaching, and getting things in front of real users all overlap.
